...
import io.monteirodev.stormy.BuildConfig;
import io.monteirodev.stormy.R;
import io.monteirodev.stormy.weather.Current;
import io.monteirodev.stormy.weather.Day;
import io.monteirodev.stormy.weather.Forecast;
import io.monteirodev.stormy.weather.Hour;
import okhttp3.Call;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = BuildConfig.FORECASTIO_KEY;
    ...
    private void updateDisplay() {
        ...
        mTemperatureLabel.setText(current.getTemperatureInCelcious() + "");
